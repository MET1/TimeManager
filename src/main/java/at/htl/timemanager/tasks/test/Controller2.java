package at.htl.timemanager.tasks.test;
 ...
 * 15.02.2016: MET 010  2200  function for setting the total time
 * 15.02.2016: MET 030  2200  basic configuration of the pie chart
 * 15.02.2016: MET 025  2200  fill combo box of members and adapt data according to selection
 * 17.03.2016: MET 040  2200  selection of extensions (ListView with CheckBoxes)
 * 12.05.2016: MET 005  2200  formatting the output of information (time, entries)
 * 24.05.2016: MET 010  2200  selecting a target directory (for saving a CSV-file)
 * 27.05.2016: MET 020  2200  saving displayed data as CSV-file
 * 27.05.2016: MET 040  2200  basic configuration of the line chart
 * 28.05.2016: MET 090  2200  line chart: working hours per month
 * 28.05.2016: MET 030  2200  line chart: axis label, display a value on hover
 * 28.05.2016: MET 080  2200  reset data in combo box, line chart and pie chart (bugs fixed)
 * 29.05.2016: MET 050  2200  deleted Tab "Settings" and adaptation to the code
 * 29.05.2016: MET 030  2200  new structure of settings (TextArea): ext, begin1, begin2 syntax, end
 * 29.05.2016: MET 010  2200  switching between source directory and source file
 * 29.05.2016: MET 005  2200  switching source file/folder: change path with triangular swap
 * 29.05.2016: MET 005  2200  set chart labels only once
 * 29.05.2016: MET 020  2200  styling "Save Data"-Button
 * 29.05.2016: MET 010  2200  set initial source and target directory
 * 29.05.2016: MET 001  2200  To Do: Import CSV, Syntax, Diagram-Labels
 * 16.06.2016: MET 040  2200  choose file: set extension filter, bug-fix, message
 * 16.06.2016: MET 015  2200  fixed TableView-Error when updating
 */
public class Controller2 implements Initializable {
    @Override
    public void initialize(URL location, ResourceBundle resources) {
        // Beim Auskommentieren bitte löschen !!!!!!!!!!!
    }
...
//            header = new String[]{"File", "Date", "Name", "Time", "Task", "Description"};
//        }
//        dataAll = data;
